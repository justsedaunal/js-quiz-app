...
function showResults() {
  ...
  userAnswers.forEach((item) => {
    ...
    currentAnswerDiv.classList.add("text-2xl" ,"border-2", "border-yellow-50", "p-2", "rounded-lg", "bg-green-50" ,"text-center","w-2/4","mx-auto");
    userAnswerDiv.classList.add("text-2xl", "border-2", "border-yellow-50", "p-2", "rounded-lg", "bg-green-50","text-center","w-2/4","mx-auto")
